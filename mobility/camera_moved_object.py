...
def main():
    ...
    urdf_path = "../data/mobility_dataset/8877/mobility.urdf"
    ...
    #cam_pos = np.array([-1.6300604343414307, -2.5109145641326904, -2.6996688842773438])
    ...
    for iteration in range(0, 100):
        ...
        if iteration < 50:
            asset.set_qpos([-2 + 0.04 * iteration, -2 + 0.04 * iteration])
        else:
            asset.set_qpos([2 - 0.04 * iteration, 2 - 0.04 * iteration])
        ...
        rgba_pil.save("color_%04d.png"%(iteration))
        ...
        color_palette[2] = [255, 0, 0]
        color_palette[3] = [0, 255, 0]
        ...
        label0_pil.save("label0_%04d.png"%(iteration))
        label1_pil = Image.fromarray(color_palette[label1_image])
        label1_pil.save("label1_%04d.png"%(iteration))
